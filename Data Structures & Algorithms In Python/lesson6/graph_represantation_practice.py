...
class Graph(object):
    ...
    def get_adjacency_list(self):
        ...
        for node in self.nodes:
            edges = [(e.node_to.value, e.value) for e in node.edges if e.node_from.value == node.value]
            if edges:
    ...
    def get_adjacency_matrix(self):
        ...
        max_node = self.get_max_node_value()+1

        # adjacency_matrix = [[0]*max_node]*max_node
